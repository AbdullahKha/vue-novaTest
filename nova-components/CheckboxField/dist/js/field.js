...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-CheckboxField', __webpack_require__(3));
  Vue.component('detail-CheckboxField', __webpack_require__(6));
  Vue.component('form-CheckboxField', __webpack_require__(9));
});
